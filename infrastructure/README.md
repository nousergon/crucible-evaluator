...
- `iam/apply.sh` + `iam/alpha-engine-evaluator-role/` policy + trust JSONs (one-time role provisioning)
- `DEPLOY.md` (completes its Phase-1 move — was already in nous-ergon-ops)
