...
# Dependencies. nousergon-lib is the AUTHORITATIVE pin here — keep this
...
RUN pip install --no-cache-dir "nousergon-lib[quant-stats,flow_doctor] @ git+https://github.com/nousergon/nousergon-lib@v0.66.0" && \
